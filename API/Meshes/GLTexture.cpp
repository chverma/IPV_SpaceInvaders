...
void GLTextureV::LoadFromResource(char *name)
{
	// make the texture name all lower case
	texturename = _strlwr(_strdup(name));
...
void GLTextureV::LoadBMP(char *name)
{
...
void GLTextureV::LoadTGA(char *name)
{
...
void GLTextureV::LoadBMPResource(char *name)
{
...
void GLTextureV::LoadTGAResource(char *name)
{
...
void GLTextureV::BuildColorTexture(unsigned char r, unsigned char g, unsigned char b)
{
