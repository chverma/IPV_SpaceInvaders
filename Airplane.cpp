...
*/
void CAirplane::AI_Init(SIAI_AI_TYPE AIType) 
{
	switch(AIType)
	{
...
///Physics methods
void CAirplane::Collided (CCharacter *CollidedChar)
{
...
void CAirplane::DisplayHit(CMesh3d &model)
{
...
//
//
void CAirplane::Render(CMesh3d &model)
{
...
void CAirplane::ChangeRenderMode(CHAR_RENDER_MODE Mode)
{
	RenderMode = Mode;
...
void CAirplane::DiscreteUpdate(void){
...
void CAirplane::ReceiveMessage(RTDESK_CMsg *pMsg){
...
void *init_ship	(LPSTR *args, CAirplane *Ship)
{
	///This is the room for may be whatever additional actions to perform this current ship initialization
	return NULL;
}

void *CS_Move	(LPSTR *args, CAirplane *Ship)
{
	Ship->AI_Move();
	return NULL;
}

void *CS_Display	(LPSTR *args, CAirplane *Ship)
{
	Ship->Render();
	return NULL;
}

void *CS_Bursting	(LPSTR *args, CAirplane *Ship)
{
	Ship->Explosion.Render();
	return NULL;
}

void *CS_Kill	(LPSTR *args, CAirplane *Ship)
{
	delete Ship;
	return NULL;
}
