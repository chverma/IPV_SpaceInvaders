...
class CSupplyShip: public CCharacter
{
	//Attributes
public:
	/// Type of supplyship
	...
	cMsgSShip *msg;
	cMsgSShip *msgUpd;							//RTDESK Message Time

	RTDESK_TIME TicksToUpdateSupplyShip;
	double msUpdSShip;

	//Methods
	void Init ();
	///Initializes the SS AI with the especified predefined FSM
...
extern char CSS_NameTransition[CSS_MAXTRANSITION][GCHAR_TAG_MAX_LONG];
